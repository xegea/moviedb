    ...
    methods: {
        async loadMore() {
            try {
                ...
                this.busy = true;
                const res = await axios.get("http://api.tvsearchdb.com:8081/content/?q=" + this.search + "&p=" + this.contentList.length / 10);
    ...
    watch : {
        search: _.debounce(async function() {
            try {
                ...
                const res = await axios.get("http://api.tvsearchdb.com:8081/content/?q=" + this.search);
